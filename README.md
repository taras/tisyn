...
| [Claude Code Plan Mode Specification](./specs/tisyn-claude-code-plan-mode-specification.md) | Draft authored Claude Code session capability, execution handle, supervision, fork, and replay semantics |
| [Claude Code Plan Mode Test Plan](./specs/tisyn-claude-code-plan-mode-test-plan.md) | Draft conformance plan for the Claude Code plan-mode authored surface |
