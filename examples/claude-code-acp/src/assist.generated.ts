...
const __m0_useClaudeCodeSession: TisynFn<[{ model: string }], unknown> =
  Fn(["config"],
    Resource(
      Let(
        "handle",
        Eval("claude-code.newSession",
          Construct({
