...
import type { Expr, Eval, Quote as QuoteT, Ref as RefT, TisynFn } from "./expr.js";
...
export function Seq<T>(...exprs: [...Expr<unknown>[], Expr<T>]): Eval<T> {
  return {
    tisyn: "eval",
    id: "seq",
...
export function Get<T>(obj: Expr<unknown>, key: string): Eval<T> {
  return {
    tisyn: "eval",
    id: "get",
...
export function Add(a: Expr<number>, b: Expr<number>): Eval<number> {
  return binary<number>("add", a, b);
}

export function Sub(a: Expr<number>, b: Expr<number>): Eval<number> {
  return binary<number>("sub", a, b);
}

export function Mul(a: Expr<number>, b: Expr<number>): Eval<number> {
  return binary<number>("mul", a, b);
}

export function Div(a: Expr<number>, b: Expr<number>): Eval<number> {
  return binary<number>("div", a, b);
}

export function Mod(a: Expr<number>, b: Expr<number>): Eval<number> {
  return binary<number>("mod", a, b);
}

export function Neg(a: Expr<number>): Eval<number> {
  return unary<number>("neg", a);
}

// ── Comparison ──

export function Gt(a: Expr<number>, b: Expr<number>): Eval<boolean> {
  return binary<boolean>("gt", a, b);
}

export function Gte(a: Expr<number>, b: Expr<number>): Eval<boolean> {
  return binary<boolean>("gte", a, b);
}

export function Lt(a: Expr<number>, b: Expr<number>): Eval<boolean> {
  return binary<boolean>("lt", a, b);
}

export function Lte(a: Expr<number>, b: Expr<number>): Eval<boolean> {
  return binary<boolean>("lte", a, b);
}

export function Eq(a: Expr<unknown>, b: Expr<unknown>): Eval<boolean> {
  return binary<boolean>("eq", a, b);
}

export function Neq(a: Expr<unknown>, b: Expr<unknown>): Eval<boolean> {
  return binary<boolean>("neq", a, b);
}

// ── Logical ──

export function And<T>(a: Expr<T>, b: Expr<T>): Eval<T> {
  return binary<T>("and", a, b);
}

export function Or<T>(a: Expr<T>, b: Expr<T>): Eval<T> {
  return binary<T>("or", a, b);
}

export function Not(a: Expr<unknown>): Eval<boolean> {
...
export function Arr<T>(...items: Expr<T>[]): Eval<T[]> {
  return {
    tisyn: "eval",
    id: "array",
...
export function Concat(...parts: Expr<unknown>[]): Eval<string> {
  return {
    tisyn: "eval",
    id: "concat",
...
export function Throw(message: Expr<string>): Eval<never> {
  return {
    tisyn: "eval",
    id: "throw",
...
export function TisynEval<T>(id: string, data: Expr<unknown>[]): Eval<T> {
  return {
    tisyn: "eval",
    id,
    data,
...
export function Race<T>(...exprs: Expr<T>[]): Eval<T> {
  return {
    tisyn: "eval",
    id: "race",
    data: { tisyn: "quote", expr: { exprs } },
