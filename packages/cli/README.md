...
After overlay application and environment resolution, the projected configuration is passed to `execute()`. Workflows access it at runtime via `yield* useConfig()`.
